...
class ROBOT: 
    ...
    def Send_Joints(self, sim):
        ...
        #Body to neck
        sim.Send_Joint(jointID=9, firstObjectID=0, secondObjectID=10, x=con.Leg*1.1, y=0, z=1.5*con.Leg + con.Radius, n1=1, n2=1, n3=0) 

        #Neck to head
        sim.Send_Joint(jointID=10, firstObjectID=10, secondObjectID=11, x=con.Leg*1.5, y=0, z=1.7 * con.Leg + con.Radius, n1=1, n2=1, n3=0) 
    ...
    def Send_Sensors(self, sim): 
        ...
        sim.Send_Light_Sensor(sensorID=6, objectID=11)
        sim.Send_Position_Sensor(sensorID=7, objectID=0)
    ...
    def Send_Neurons(self, sim):
        ...
        #Motor neurons
        for mn in range(0,11): 
            sim.Send_Motor_Neuron(neuronID=mn+7, jointID=mn, tau=0.3) 
    ...
    def Send_Synapses(self, sim, wts): 
        for s in range(0, 7): 
          for v in range(0,11): 
            sim.Send_Synapse(sourceNeuronID=s, targetNeuronID= v + 7, weight=wts[s][v]) 
